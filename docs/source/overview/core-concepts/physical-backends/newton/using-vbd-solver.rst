...
.. code-block:: bash
    ...
    ./isaaclab.sh -p scripts/environments/state_machine/lift_franka_soft.py --task IsaacContrib-Lift-Soft-Franka --num_envs 1 --visualizer kit

For the surface-deformable cloth variant, use:

.. code-block:: bash

    ./isaaclab.sh -p scripts/environments/state_machine/lift_franka_soft.py --task IsaacContrib-Lift-Cloth-Franka --num_envs 1 --visualizer kit
...
.. code-block:: bash
    ...
    ./isaaclab.sh -p scripts/environments/random_agent.py --task IsaacContrib-Lift-Soft-Franka --num_envs 1 physics=newton_mjwarp_vbd

or select the physics field directly:

.. code-block:: bash

    ./isaaclab.sh -p scripts/environments/random_agent.py --task IsaacContrib-Lift-Soft-Franka --num_envs 1 env.sim.physics=newton_mjwarp_vbd
...
default for ``IsaacContrib-Lift-Soft-Franka``) that demonstrates the typical
configuration:
...
.. code-block:: bash
    ...
    ./isaaclab.sh -p scripts/environments/random_agent.py --task IsaacContrib-Lift-Soft-Franka --num_envs 1 --visualizer kit
    ...
    ./isaaclab.sh -p scripts/environments/random_agent.py --task IsaacContrib-Lift-Soft-Franka --num_envs 1 presets=newton_mjwarp_vbd
