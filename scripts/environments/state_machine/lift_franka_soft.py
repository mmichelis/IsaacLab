...
.. code-block:: bash
    ...
    ./isaaclab.sh -p scripts/environments/state_machine/lift_franka_soft.py --task IsaacContrib-Lift-Cloth-Franka
...
parser.add_argument("--task", type=str, default="IsaacContrib-Lift-Soft-Franka", help="The task to run.")
