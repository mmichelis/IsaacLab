...
* Added :class:`~isaaclab_tasks.core.lift.config.franka_soft.franka_cable_plug_env_cfg.FrankaCablePlugEnvCfg`
...
* Added :func:`~isaaclab_tasks.core.lift.config.franka_soft.mdp.assembly_velocity_out_of_bounds`,
...
* Added a no-cable variant ``Isaac-Lift-Plug-Franka-v0`` (config
  :class:`~isaaclab_tasks.core.lift.config.franka_soft.franka_cable_plug_env_cfg.FrankaCablePlugNoCableEnvCfg`,
...
* Added :func:`~isaaclab_tasks.core.lift.config.franka_soft.mdp.object_grasped`, a
...
* Added :func:`~isaaclab_tasks.core.lift.config.franka_soft.mdp.object_grasped_goal_distance`,
