...
* Added a step-based curriculum to the Franka cable-plug environments that incrementally widens the
  ...
  over training, via the new :func:`~isaaclab_tasks.manager_based.manipulation.lift_franka_soft.mdp.step_widen_pose_range`
  curriculum term, and ramps the episode length from short to long via
  :func:`~isaaclab_tasks.manager_based.manipulation.lift_franka_soft.mdp.step_interpolate_value`.
