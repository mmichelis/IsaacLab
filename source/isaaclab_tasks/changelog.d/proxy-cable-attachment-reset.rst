...
* Added :func:`~isaaclab_tasks.manager_based.manipulation.lift_franka_soft.mdp.reset_cable_uniform`
  and :func:`~isaaclab_tasks.manager_based.manipulation.lift_franka_soft.mdp.reset_cable_assembly_uniform`
  ...
  :class:`~isaaclab_tasks.manager_based.manipulation.lift_franka_soft.franka_cable_env_cfg.FrankaCableEnvCfg`
  and
  :class:`~isaaclab_tasks.manager_based.manipulation.lift_franka_soft.franka_cable_pendulum_env_cfg.FrankaCablePendulumEnvCfg`
  ``EventCfg``.
