...
from isaaclab_physx.sim.spawners.materials.physics_materials_cfg import DeformableBodyMaterialCfg, SurfaceDeformableBodyMaterialCfg
...
@configclass
class HumanoidYogaballSceneCfg(InteractiveSceneCfg):
    """Configuration for a humanoid yogaball scene."""
...
@configclass
class HumanoidYogaballEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the humanoid yogaball environment."""

    # Scene settings
    scene: HumanoidYogaballSceneCfg = HumanoidYogaballSceneCfg(num_envs=1024, env_spacing=4.0, replicate_physics=False)
    # Basic settings
